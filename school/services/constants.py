...
# --- Достоверность прогноза (ТЗ 4.4) ---
# Объём первичных баллов, при котором фактор считается насыщенным
PREDICTION_EVIDENCE_TARGET = 60.0
# Число различных дней с результатами для насыщения фактора распределённости
PREDICTION_SPREAD_TARGET = 6
# Период полураспада свежести данных, дней
PREDICTION_RECENCY_HALF_LIFE = 45.0
